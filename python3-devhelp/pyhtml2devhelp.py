#! /usr/bin/python3
# Borrowed from debian's python3 package
...
def main():
    ...
    print('<book title="Python %s Documentation" name="Python %s" version="%s" link="index.html" language="Python3" >' % (version, version, version))
    print('<chapters>')
